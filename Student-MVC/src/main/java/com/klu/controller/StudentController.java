...
public class StudentController {
	...
	public Student updateStudent(@PathVariable int id, @RequestBody Student studnet) {
		return service.updateStudent(id, studnet);
	}
	...
	@GetMapping("/student/search/{name}/{course}")
